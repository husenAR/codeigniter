...
// tutup home
	...
	public function submitpresensipegawai(){
		...
		redirect('sistem/pegawai/presensipegawai');
	...
	public function editprofil(){
		...
		if($this->input->post('submit')){
			...
			redirect('sistem/pegawai/editprofil');
		} 
	}
	...
	public function hasil_klinik_un() {
		...
		redirect('sistem/pegawai/distribusi/klinik_un');
	...
	public function hapus_klinik_un($id){
		...
		redirect('sistem/pegawai/klinik_un');
	}
...
public function mutasi_masuk(){
	...
	public function simpan_form_mutasi() 
	{
		...
		redirect('sistem/pegawai/distribusi/mutasi_masuk');
	}
...
// tutup anggrek
	...
	public function ubahstatus() 
	{
		...
		redirect('sistem/pegawai/ppdbujian');
	...
	public function simpanharirentang() {
		...
		redirect('sistem/pegawai/harirentang');
	}
	...
	public function simpanjammengajar() 
	{
		...
		redirect('sistem/pegawai/jammengajar');
	}
	...
	public function simpanprioritas() {
		...
		redirect('sistem/pegawai/jadwalmapel');
	}
	...
	public function simpanjadwalpiketguru() 
	{
		...
		redirect('sistem/pegawai/jadwalpiketguru');
	}
	...
	public function hapusjadwaltambahan() {
		...
		redirect('sistem/pegawai/jadwaltambahan');
	}
	...
	public function ekstrakurikuler($id_jadwal_ekskul = "")
	{
		...
		// redirect('sistem/pegawai/ekstrakurikuler');
	}
	...
	public function hapusnamamapel() {
		...
		redirect('sistem/pegawai/namamapel');
	}
	// Tutup Mia 
...
// Penilaian Hafiz
	...
	public function submitpresensisiswa(){
		...
		redirect('sistem/pegawai/presensi_siswa');
