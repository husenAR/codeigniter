...
<div class="wrapper">
  ...
  <li class="treeview active">
    ...
    <ul class="treeview-menu">
      ...
      <li class="active"><a href="kurikulum.php"><i class="fa fa-circle-o text-red"></i> <span>Kurikulum</span></a></li>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
               ...
               <div class="box">
                ...
                <center><embed src="dokumen_kurikulum/dokumenkurikulum.pdf" width="1000" height="1000"> </embed></center>
              </div>
              </div>
              </div>
