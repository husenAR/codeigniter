        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="datakelolamapel">
             <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpannamamapel'); ?>">
                    ...
                    foreach ($tabel_namamapel as $row_namamapel) {
                      ...
                      <tr>
                        ...
                        <td> 
                          ...
                          <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('penjadwalan/kurikulum/namamapel/'.$row_namamapel->id_namamapel); ?>" > Edit </a>
                          <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('penjadwalan/kurikulum/hapusnamamapel/'.$row_namamapel->id_namamapel); ?>" > Hapus </a>
                        </td>               
                      </tr>
                      <?php
