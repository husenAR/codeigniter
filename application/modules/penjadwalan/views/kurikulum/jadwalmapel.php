            ...
            <div class="tab-pane" id="jadwalmapel">
              <div class="box">
                <div class="box-header">
                  <form>
                    <select id="jenjangjadwalmapel2" onchange="document.location = '<?php echo site_url('penjadwalan/kurikulum/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel2').value;">
                      ...
                      for($i=0;$i<=12;$i++)  {
                        ...
                        <tr>
                          ...
                          foreach (@$tabel_jammengajar as $rowjammengajar) {
                            ...
                            if ($ada == false) {
                              if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>';  $sudah = true;
                            }
                          }
                        }
                  ...
                  <tr>
                    ...
                    foreach ($tabel_kelasreguler as $key => $row_kelasreguler) {
                      ...
                      foreach (@$tabel_jammengajar as $rowjammengajar) {
                        ...
                        if ($ada == false) {
                         if ((@$tabel_jadwalmapel_selasa[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_selasa[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>'; $sudah = true;
                       }
                     }
                   }
            ...
            for($i=0;$i<=12;$i++)  {
              ...
              <tr>
                ...
                foreach (@$tabel_jammengajar as $rowjammengajar) {
                  ...
                  if ($ada == false) {
                    if ((@$tabel_jadwalmapel_rabu[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_rabu[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>'; $sudah = true;
                  }
                }
              }
        ...
        for($i=0;$i<=12;$i++)  {
          ...
          <tr>
            ...
            foreach (@$tabel_jammengajar as $rowjammengajar) {
              ...
              if ($ada == false) {
                if ((@$tabel_jadwalmapel_kamis[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_kamis[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>';  $sudah = true;
              }
            }
          }
    ...
    for($i=0;$i<=12;$i++)  {
      ...
      <tr>
        ...
        foreach (@$tabel_jammengajar as $rowjammengajar) {
          ...
          if ($ada == false) {
            if ((@$tabel_jadwalmapel_jumat[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_jumat[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>';  $sudah = true;
          }
        }
      }
    ...
    for($i=0;$i<=12;$i++)  {
      ...
      <tr>
        ...
        foreach (@$tabel_jammengajar as $rowjammengajar) {
          ...
          if ($ada == false) {
            if ((@$tabel_jadwalmapel_sabtu[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_sabtu[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>'; $sudah = true;
          }
        }
      }
    ...
    for($i=0;$i<=12;$i++)  {
      ...
      <tr>
        ...
        foreach (@$tabel_jammengajar as $rowjammengajar) {
          ...
          if ($ada == false) {
            if ((@$tabel_jadwalmapel_minggu[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_minggu[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo '<th bgcolor="'.@$rowjammengajar->warna.'">'.$rowjammengajar->nama."(".$rowjammengajar->nama_panggilan.")".'</th>'; $sudah = true;
          }
        }
      }
      if ($sudah == false) {
...
<!-- <a href="<?php echo site_url('penjadwalan/kurikulum/printjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-print text-red "></i> Print</button></a> -->
<a href="<?php echo site_url('penjadwalan/kurikulum/exportjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-upload text-red "></i> Export</button></a>
</div>
<!-- /.box-body -->
</div>
                     ...
                     for($i=0;$i<=5;$i++) {
                      ...
                      <tr>
                        ...
                        foreach (@$tabel_prioritaskhusus_senin[$i] as $rowprioritaskhusus) {
                          $z++;
                          if ($z>1) { echo ", "; }
                          echo $rowprioritaskhusus->nama.'&nbsp;<a href="'.site_url('penjadwalan/kurikulum/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                        }
                        ?> </th>
                        <th><?php 
                        $z=0;
...
<div class="tab-pane" id="jadwalkhusus">
            ...
            for($i=0;$i<=12;$i++) {
              ...
              <tr>
                ...
                foreach (@$tabel_khusus_senin[$i] as $rowprioritaskhusus) {
                  $z++;
                  if ($z>1) { echo ", "; }
                  echo $rowprioritaskhusus->nama_panggilan.'&nbsp;<a href="'.site_url('penjadwalan/kurikulum/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                }
                ?> </th>
                <th><?php 
                $z=0;
  ...
  <div class="tab-pane" id="kelolajadwalmapel">
    <div class="box">
      <div class="box-header">
        <form>
          <select id="jenjangjadwalmapel" onchange="document.location = '<?php echo site_url('penjadwalan/kurikulum/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel').value;">
            <option value="7" <?php if ($jenjang == '7') { echo " selected"; } ?>> KELAS 7</option>
            <option value="8" <?php if ($jenjang == '8') { echo " selected"; } ?>> KELAS 8</option>
            <option value="9" <?php if ($jenjang == '9') { echo " selected"; } ?>> KELAS 9</option>
          </select>
      ...
      <div class="box-body">
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/senin/'.$jenjang); ?>">
                      ...
                      <th>
                        <select data-placeholder="Pilih" class="kodeguru" name="jadwal_senin_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_senin_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                          ...
                          foreach (@$tabel_jammengajar as $rowjammengajar) {
                            ...
                            if ($ada == false) {
                              ?>
                              <option class="putih" value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>" <?php if ((@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_senin[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo " selected"; } ?>><?php echo $rowjammengajar->nama; ?>(<?php echo $rowjammengajar->nama_panggilan; ?>)</option>
                              <?php
                            }
                          }
                          ?>
        ...
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/selasa/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/rabu/'.$jenjang); ?>">
                    ...
                    <th>
                      <select data-placeholder="Pilih" class="kodeguru" name="jadwal_rabu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_rabu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        ...
                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                          ...
                          if ($ada == false) {
                            ?>
                            <option class="putih" value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>" <?php if ((@$tabel_jadwalmapel_rabu[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_rabu[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo " selected"; } ?>><?php echo $rowjammengajar->nama; ?>(<?php echo $rowjammengajar->nama_panggilan; ?>)</option>
                            <?php
                          }
                        }
                        ?>
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/kamis/'.$jenjang); ?>">
                    ...
                    <th>
                      <select data-placeholder="Pilih" class="kodeguru" name="jadwal_kamis_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_kamis_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        ...
                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                          ...
                          if ($ada == false) {
                            ?>
                            <option class="putih" value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>" <?php if ((@$tabel_jadwalmapel_kamis[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_kamis[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo " selected"; } ?>><?php echo $rowjammengajar->nama; ?>(<?php echo $rowjammengajar->nama_panggilan; ?>)</option>
                            <?php
                          }
                        }
                        ?>
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/jumat/'.$jenjang); ?>">
                    ...
                    <th>
                      <select data-placeholder="Pilih" class="kodeguru" name="jadwal_jumat_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_jumat_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        ...
                        foreach (@$tabel_jammengajar as $rowjammengajar) {
                          ...
                          if ($ada == false) {
                            ?>
                            <option class="putih" value="<?php echo $rowjammengajar->NIP; ?>_<?php echo $rowjammengajar->id_namamapel; ?>" <?php if ((@$tabel_jadwalmapel_jumat[$row_kelasreguler->id_kelas_reguler][$i][0]->NIP == $rowjammengajar->NIP) && (@$tabel_jadwalmapel_jumat[$row_kelasreguler->id_kelas_reguler][$i][0]->id_namamapel == $rowjammengajar->id_namamapel)) { echo " selected"; } ?>><?php echo $rowjammengajar->nama; ?>(<?php echo $rowjammengajar->nama_panggilan; ?>)</option>
                            <?php
                          }
                        }
                        ?>
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/sabtu/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalguru/minggu/'.$jenjang); ?>">
