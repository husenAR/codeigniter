            ...
            <div class="tab-content">
              <div class="tab-pane" id="jadwalpiket">
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <button class="btnjdwl btn btn-default" onclick="window.open('<?php echo site_url('penjadwalan/kurikulum/printjadwalpiketguru/'.$id_tahun_ajaran); ?>', 'winpopup', 'menubar=no,toolbar=no,resizeable=yes,statusbar=no,top=50,left=50,width=800,height=600');"><i class="fa fa-print text-red "></i> Print</button>
                  </div>
                  <!-- /.box-body -->
                </div>             
              </div>
              ...
              <div class="active tab-pane" id="kelolajadwalpiket">
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalpiketguru'); ?>">
                    <table class="table table-bordered table-striped tabelmapel">
                      <thead>
                        <select class="kodepiket" name="id_tahun_ajaran" id="pilih_id_tahun_ajaran" onchange="document.location='<?php echo site_url('penjadwalan/kurikulum/jadwalpiketguru'); ?>/' + document.getElementById('pilih_id_tahun_ajaran').value;">
                              <?php
                            foreach ($tabel_tahunajaran as $row_tahunajaran) {
                            ?>
