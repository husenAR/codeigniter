            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="kelolajadwaltambahan">
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwaltambahan'); ?>">
                    ...
                    <tbody>
                      ...
                      foreach ($tabel_jadwaltambahan as $row_jadwaltambahan) {
                        ...
                        <tr>
                          ...
                          <td> 
                            <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('penjadwalan/kurikulum/jadwaltambahan/'.$row_jadwaltambahan->id_jadwal_tambahan); ?>" > Edit </a>
                            <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('penjadwalan/kurikulum/hapusjadwaltambahan/'.$row_jadwaltambahan->id_jadwal_tambahan); ?>" > Hapus </a>
                          </td>               
                        </tr>
                        <?php
                      }
