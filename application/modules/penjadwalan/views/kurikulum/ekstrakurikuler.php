        ...
        <div class="nav-tabs-custom">
         ...
         <div class="tab-content">
          <div class="active tab-pane" id="dataekskul">
            <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjadwalekskul'); ?>">
                ...
                <tbody>
                  ...
                  foreach ($tabel_jadwalekskul as $row_jadwalekskul) {
                    ...
                    <tr>
                      ...
                      <td> 
                        <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('penjadwalan/kurikulum/ekstrakurikuler/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Edit </a>
                        <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('penjadwalan/kurikulum/hapusjadwalekskul/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Hapus </a>
                      </td>               
                    </tr>
                    <?php
                  }
