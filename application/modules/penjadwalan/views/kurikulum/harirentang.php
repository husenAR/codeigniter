  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="row">
        ...
        <!-- /.col -->
        <div class="col-md-12">
          <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanharirentang'); ?>">
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['senin'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['selasa'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['rabu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> --> 
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['kamis'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['jumat'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['sabtu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      <thead>
                        <tr>
                          ...
                          <th style="width: 3%">Jam Mulai</th>
                          <th style="width: 5%">Jam Selesai</th>
                          <th style="width: 5%">TES MINGGU</th>
                          <th style="width: 20%"></th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('penjadwalan/kurikulum/delharirentang/'.@$hari_rentang['minggu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
