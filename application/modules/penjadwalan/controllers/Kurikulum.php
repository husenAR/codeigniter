...
class Kurikulum extends CI_Controller {
	...
	public function harirentang()
	{
		...
		$this->load->model('mod_harirentang');
		...
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/harirentang', $data);
	}
	...
	public function jammengajar()
	{
		...
		$this->load->model('mod_jammengajar');
		...
		$this->load->model('mod_jadwalmapel');
		...
		$this->load->model('mod_namamapel');
		$data['tabel_namamapel'] = $this->mod_namamapel->get();
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/jammengajar', $data);
	}
	...
	public function jadwalmapel()
	{
		...
		$this->load->model('mod_prioritaskhusus');
		...
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/jadwalmapel', $data);
	}


	// public function printjadwalmapel()
	// {
	...
	// 	$this->load->view('kurikulum/printjadwalmapel', $data);
	// }
	...
	public function exportjadwalmapel()
	{
		...
		$this->load->view('kurikulum/exportjadwalmapel', $data);
	}
...
// 			$data['tabel_prioritaskhusus_jumat'][$i] = $this->mod_prioritaskhusus->get(array("hari"=>"Jumat", "jam_ke"=>$i, "jenis_prkh"=>"prioritas"));
// 			$data['tabel_prioritaskhusus_sabtu'][$i] = $this->mod_prioritaskhusus->get(array("hari"=>"Sabtu", "jam_ke"=>$i, "jenis_prkh"=>"prioritas"));
// 			$data['tabel_prioritaskhusus_minggu'][$i] = $this->mod_prioritaskhusus->get(array("hari"=>"Minggu", "jam_ke"=>$i, "jenis_prkh"=>"prioritas"));	// public function getmapelkelas($jenjang)
	// {
	// 	$this->load->model('mod_mapel');
	// 	//$tabel_pegawai = $this->mod_pegawai->get(array("Status"=>"Guru"));
	...
	public function jadwalpiketguru()
	{
		...
		$this->load->model('mod_jadwalpiketguru');
		...
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/jadwalpiketguru', $data);
	}
	...
	public function printjadwalpiketguru() //$id_tahun_ajaran="")
	{
		...
		//$this->load->view('kurikulum/printjadwalpiketguru', $data);
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/printjadwalpiketguru', $data);
	}
	...
	public function jadwaltambahan($id_jadwal_tambahan = "")
	{
		...
		if ($id_jadwal_tambahan == "" ) {
			$this->load->model('mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('mod_namamapel');
			$data['tabel_namamapel'] = $this->mod_namamapel->get();
			$this->load->model('mod_pegawai');
			$data['tabel_pegawai'] = $this->mod_pegawai->get();
			$this->load->model('mod_jadwaltambahan');
			$data['tabel_jadwaltambahan'] = $this->mod_jadwaltambahan->get();
			$data['edit_jadwaltambahan'] = null;
			
			$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/jadwaltambahan', $data);
		} else {
			$this->load->model('mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('mod_namamapel');
	...
	public function namamapel($id_namamapel = "")
	{
		...
		if ($id_namamapel == "" ) {
			...
			$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/namamapel', $data);
		} else {
			$this->load->model('mod_namamapel');
	...
	public function printjadwalmapeldiv(){
		...
		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/printjadwalmapeldiv',$data);
	}

	// public function ekstrakurikuler()
	// {
	// 	if ($id_jadwal_ekskul == "" ) {
	// 		$this->load->model('mod_ekstrakulikuler');
	// 		$data['tabel_ekskul'] = $this->mod_ekstrakulikuler->get();
	// 		$data['edit_ekskul'] = null;
	// 		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/ekstrakurikuler', $data);	
	// 	} else {
	// 		$this->load->model('mod_ekstrakulikuler');
	// 		$data['tabel_ekskul'] = $this->mod_ekstrakulikuler->get();
	// 		$data['edit_ekskul'] = $this->mod_ekstrakulikuler->select($id_jadwal_ekskul);
	// 		$this->template->load('kurikulum/dashboard_kurikulum','kurikulum/ekstrakurikuler', $data);
	// 	}
	// }
	...
	// 		if ($this->mod_mapel->cekmapel($this->input->post('nama_mapel'), $this->input->post('grade')) == 0) {
	// 			$this->mod_mapel->insert($data);	
	// 		} 
