...
class Gurupiket extends CI_Controller {
	...
	public function pendaftaran(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/pembimbing/pendaftaran', $data);
	}

	public function jadwal(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/pembimbing/jadwal', $data);
	}

	public function presensi(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/pembimbing/presensi', $data);
	}

	public function nilai(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/pembimbing/nilai', $data);
	}

	public function pembayaran(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/pembimbing/pembayaran', $data);
	}
	// TUTUP PEMBIMBING
	...
	public function keterlambatan(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/konseling/keterlambatan', $data);
	}

	public function absensi_harian(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/konseling/absensi_harian', $data);
	}

	public function pelanggaran(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/konseling/pelanggaran', $data);
	}

	public function prestasi(){
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->template->load('gurupiket/dashboard','gurupiket/konseling/prestasi', $data);
	}
	...
	public function mapel($id_kelas_reguler = "", $jenjang = "", $id_namamapel = "")
	{
		...
		if ($id_kelas_reguler == "" ) {
			...
			$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/mapel', $data);	
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
			$data['tabel_namamapel'] = $this->mod_namamapel->get();
			$this->load->model('penjadwalan/mod_mapel');
...
public function simpanmapel() {
	...
	// 		$data['tabel_kelasreguler'] = $this->mod_kelasreguler->getgroupby();
	// 		$data['edit_mapel'] = null;
	// 		$this->template->load('gurupiket/dashboard_kurikulum','gurupiket/mapel', $data);	
	// 	} else {
	// 		$this->load->model('penjadwalan/mod_mapel');
	// 		$data['tabel_mapel'] = $this->mod_mapel->getgroupbyjenjang();
	// 		$this->load->model('penjadwalan/mod_kelasreguler');
	...
	public function harirentang()
	{
		...
		$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/harirentang', $data);
	}
	...
	public function simpanharirentang() {
		...
		redirect('gurupiket/harirentang');
	}
	...
	// 	$this->load->model('penjadwalan/mod_namamapel');
	// 	$data['tabel_namamapel'] = $this->mod_namamapel->get();
	// 	$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/jammengajar', $data);
	// }
...
public function jammengajar()
	 ...
	 public function printjammengajar()
	{
		...
		$this->load->model('penjadwalan/mod_namamapel');
		$data['tabel_namamapel'] = $this->mod_namamapel->get();
		$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/printjammengajar', $data);
	 }
	...
	public function simpanjammengajar() 
	{
		...
		$this->session->set_flashdata("warning",'<script> swal( "Berhasil" ,  "Data tersimpan !" ,  "success" )</script>');	
		redirect('gurupiket/jammengajar');
	}
	...
	public function jadwalmapel()
	{
		...
		$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/jadwalmapel', $data);
	}
	...
	public function exportjadwalmapel()
	{
		...
		$this->load->view('gurupiket/kurikulum/penjadwalan/exportjadwalmapel', $data);
	}
	...
	public function simpanprioritas() {
		...
		redirect('gurupiket/jadwalmapel');
	}
	...
	public function jadwalpiketguru()
	{
		...
		$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/jadwalpiketguru', $data);
	}
	...
	public function simpanjadwalpiketguru() 
	{
		...
		redirect('gurupiket/jadwalpiketguru');
	}
	public function printjadwalpiketguru() //$id_tahun_ajaran="")
	{
		...
		$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/printjadwalpiketguru', $data);
	}
	...
	public function jadwaltambahan($id_jadwal_tambahan = "")
	{
		...
		if ($id_jadwal_tambahan == "" ) {
			...
			$data['nama'] = $this->session->Nama;
			$data['foto'] = $this->session->foto;
			$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/jadwaltambahan', $data);
		} else {
			$this->load->model('penjadwalan/mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('penjadwalan/mod_namamapel');
	...
	public function hapusjadwaltambahan() {
		...
		redirect('gurupiket/jadwaltambahan');
	}
	...
	public function getmapelkelastambahan()
	{
		...
		$this->template->load('gurupiket/dashboard','gurupiket/jadwaltambahan', $data);
	}
	...
	public function ekstrakurikuler($id_jadwal_ekskul = "")
	{
		if ($id_jadwal_ekskul == "" ) {
			...
			$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/ekstrakurikuler', $data);
		} else {
			$this->load->model('penjadwalan/mod_jadwalekskul');
			$data['tabel_jadwalekskul'] = $this->mod_jadwalekskul->get();
			$data['nama'] = $this->session->Nama;
		...
		// redirect('gurupiket/ekstrakurikuler');
	}
	...
	public function namamapel($id_namamapel = "")
	{
		if ($id_namamapel == "" ) {
			...
			$this->template->load('gurupiket/dashboard','gurupiket/kurikulum/penjadwalan/namamapel', $data);
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
