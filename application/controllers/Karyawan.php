...
// tutup anggrek
	...
	public function mapel($id_kelas_reguler = "", $jenjang = "", $id_namamapel = "")
	{
		...
		if ($id_kelas_reguler == "" ) {
			...
			$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/mapel', $data);	
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
			$data['tabel_namamapel'] = $this->mod_namamapel->get();
			$this->load->model('penjadwalan/mod_mapel');
	...
	// 		$data['tabel_kelasreguler'] = $this->mod_kelasreguler->getgroupby();
	// 		$data['edit_mapel'] = null;
	// 		$this->template->load('karyawan/dashboard_kurikulum','karyawan/mapel', $data);	
	// 	} else {
	// 		$this->load->model('penjadwalan/mod_mapel');
	// 		$data['tabel_mapel'] = $this->mod_mapel->getgroupbyjenjang();
	// 		$this->load->model('penjadwalan/mod_kelasreguler');
	...
	public function harirentang()
	{
		...
		$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/harirentang', $data);
	}
	...
	// 	$this->load->model('penjadwalan/mod_namamapel');
	// 	$data['tabel_namamapel'] = $this->mod_namamapel->get();
	// 	$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/jammengajar', $data);
	// }
...
public function jammengajar()
	 ...
	 public function printjammengajar()
	{
		...
		$this->load->model('penjadwalan/mod_namamapel');
		$data['tabel_namamapel'] = $this->mod_namamapel->get();
		$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/printjammengajar', $data);
	 }
	...
	public function jadwalmapel()
	{
		...
		$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/jadwalmapel', $data);
	}
	...
	public function exportjadwalmapel()
	{
		...
		$this->load->view('karyawan/kurikulum/penjadwalan/exportjadwalmapel', $data);
	}
	...
	public function jadwalpiketguru()
	{
		...
		$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/jadwalpiketguru', $data);
	}
	...
	public function printjadwalpiketguru() //$id_tahun_ajaran="")
	{
		...
		$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/printjadwalpiketguru', $data);
	}
	...
	public function jadwaltambahan($id_jadwal_tambahan = "")
	{
		...
		if ($id_jadwal_tambahan == "" ) {
			...
			$data['nama'] = $this->session->Nama;
			$data['foto'] = $this->session->foto;
			$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/jadwaltambahan', $data);
		} else {
			$this->load->model('penjadwalan/mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('penjadwalan/mod_namamapel');
	...
	public function getmapelkelastambahan()
	{
		...
		$this->template->load('karyawan/dashboard','karyawan/jadwaltambahan', $data);
	}
	...
	public function ekstrakurikuler($id_jadwal_ekskul = "")
	{
		if ($id_jadwal_ekskul == "" ) {
			...
			$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/ekstrakurikuler', $data);
		} else {
			$this->load->model('penjadwalan/mod_jadwalekskul');
			$data['tabel_jadwalekskul'] = $this->mod_jadwalekskul->get();
			$data['nama'] = $this->session->Nama;
	...
	public function namamapel($id_namamapel = "")
	{
		if ($id_namamapel == "" ) {
			...
			$this->template->load('karyawan/dashboard','karyawan/kurikulum/penjadwalan/namamapel', $data);
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
